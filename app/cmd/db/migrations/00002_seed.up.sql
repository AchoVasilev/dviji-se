INSERT INTO categories(id, name, slug, icon, image_url)
VALUES ('5206274b-b473-49c1-bcca-6516838a9f1e', 'Рецепти', 'recepti', 'restaurant',
        'https://res.cloudinary.com/dpo3vbxnl/image/upload/v1691940539/onlygains/categories/istock-1155240408_stpuam.jpg'),
       ('a1f06571-2f00-43a8-9ab9-401c802237cd', 'Упражнения', 'uprazhneniya', 'fitness_center',
       ...
       ('9fd30320-8e71-4a76-aff8-8b82fccb68e7', 'Тренировъчни програми', 'trenirovachni-programi', 'directions_run',
        'https://res.cloudinary.com/dpo3vbxnl/image/upload/v1691941043/onlygains/categories/TheNotebook_pd92nm.jpg'),
       ('c40af472-04fc-4c51-aeb6-22818645f824', 'Фитнес зали', 'fitnes-zali', 'home',
       ...
       ('5e01b7ad-c631-470e-b330-54ac9a503b57', 'Хранителни режими', 'hranitelni-rezhimi', 'description',
        'https://res.cloudinary.com/dpo3vbxnl/image/upload/v1691941490/onlygains/categories/image04-4_hgly6c.jpg'),
       ('272e0edd-11e8-4709-bbba-5d36d77dd428', 'Сред природата', 'sred-prirodata', 'terrain',
